...
public class Game {
    ...
    private boolean isThisGameOver() {
        ...
        return (gamePlayerDestroyedAllShipsFromOtherGamePlayer(player1, player2) ||
                gamePlayerDestroyedAllShipsFromOtherGamePlayer(player2, player1))
                && player1.getSalvoes().size() == player2.getSalvoes().size();
    }

    private boolean gamePlayerDestroyedAllShipsFromOtherGamePlayer(GamePlayer gamePlayer, GamePlayer otherGamePlayer) {
